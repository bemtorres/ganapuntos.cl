...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('de_solicitud', function (Blueprint $table) {
            ...
            $table->foreign('id_usuario_solicitante')->references('id')->on('gp_usuario');

            $table->unsignedBigInteger('id_usuario_receptor')->nullable();
            $table->foreign('id_usuario_receptor')->nullable()->references('id')->on('gp_usuario');
