              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="card form-group">
                    <div class="card-header">
                      <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="cant_per_user_swith" name="cant_per_user_swith" onclick="checkItem(this, 'panel2', 'cant_per_user');" checked>
                    ...
                    <div class="card-body" id="panel2">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
                            <input type="number" class="form-control" readonly min="1" name="cant_per_user" id="cant_per_user" value="{{ old('cant_per_user') }}"/>
                          </div>
                        </div>
                      </div>
                    </div>
